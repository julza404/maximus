    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0f1117] px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-2xl font-semibold text-[#f0f2f8]">Set new password</h1>
          <p className="mt-1 text-sm text-[#8892a4]">Choose a strong password for your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="confirm" className="block text-sm text-[#8892a4] mb-1.5">
              Confirm password
            </label>
            <input
              id="confirm"
